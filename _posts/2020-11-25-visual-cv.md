...
be too hard to incorporate all the features I wanted to have without
...
with the richness of information, in code (also I am terrible at
drawing/painting).
...
-   milestones (papers) are also depicted as round points, and in
    keeping with my trajectory there some to which I contributed only
...
but doesn’t feel cluttered. Also, this is not meant to be a
self-contained, self-explanatory piece of data visualization - I will be
...
each place of work, and follow that up with slides describing the my
role, tasks, and accomplishments. So in effect highlighting the laces of
work in a stepwise manner is critical to create breaks and setting the
tone for each part of the presentation.

Removing the legend is fairly simple (once you know who to do it and I
always google it).
